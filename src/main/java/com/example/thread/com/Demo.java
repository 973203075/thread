...
public class Demo {
    ...
    public static void generateImage(OutputStream os, double percent, int radius){
        ...
        try{
            ...
            BufferedImage bg = ImageIO.read(new File("C:\\var\\data\\templates\\export\\manufacture\\image\\bg.png"));//仪表盘背景
            BufferedImage pointer = ImageIO.read(new File("C:\\var\\data\\templates\\export\\manufacture\\image\\pointer.png"));//仪表盘指针
...
//-10.0到370度的测试
        for(double i = -10.0; i < 370.1; i += 10.0){
            ...
            FileOutputStream fos = new FileOutputStream(new File("C:\\var\\data\\templates\\export\\manufacture\\img\\" + i + ".png"));
